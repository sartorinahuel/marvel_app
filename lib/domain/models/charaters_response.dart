...
///
///Response class to get data from de API
///
class CharactersResponse {
  ...
  CharactersResponse({this.code, this.status, this.copyright, this.attributionText, this.attributionHtml, this.etag, this.data});
...
class Data {
  ...
  Data.fromJson(Map<String, dynamic> json) {
    ...
    if (json["results"] is List)
      this.results = json["results"] == null ? [] : (json["results"] as List).map((e) => Character.fromJson(e)).toList();
  }
